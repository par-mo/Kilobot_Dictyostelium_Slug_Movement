...
\section{Collective Decision-Making Strategy}
We design a decentralized decision-making strategy to allow the robots to decide between different options, based on their neighbors in the chain. 
