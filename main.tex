...
%%------------------------------------------------------------------------------------------------------------
\section {Kilobots} 
To program Kilobots, we use an overhead infrared transmitter instead of plug-in cable, which allows us to program all the Kilobots collectively once in a time.
\subsection{Direction Finding}
A Kilobot can determine the distance to the message sender based on the signal strength. 
