...
The idea of simulation of slug movement in \textit{Dictyostelium discoideum} is to have a swarm of kilobots which moves in one direction in a decentralized way as in a leader-follower manner.  As we know from aggregation phase, $20\%$ of the cell population belongs  to pst cells and the other $80\%$ belong to psp cells category. 
